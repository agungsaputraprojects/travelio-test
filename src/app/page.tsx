          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 hidden sm:block">Search less, Read more</p>
              </div>
            </div>
        ...
        {!showWishlist && !searchState.hasSearched && (
          <div className="text-center mb-12">
            <div className="mb-8">
              ...
              Search Less, 
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent ms-3">
                Read More
                </span>
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
              Quickly find the books that matter to you. Save time, stay inspired, and let your next great read come to you.
              </p>
